...
export function getBrowserWalletAdapter(
  ...
  const rawSignMessage =
    (solana.signMessage as unknown as (input: Uint8Array | { message: Uint8Array; display?: string }) => Promise<unknown>) ??
    (fallbackSignMessage as unknown as (input: Uint8Array | { message: Uint8Array; display?: string }) => Promise<unknown>);
  const signMessage =
    rawSignMessage &&
    (async (message: Uint8Array): Promise<Uint8Array> => {
      const attempt = async (input: Uint8Array | { message: Uint8Array; display?: string }) => {
